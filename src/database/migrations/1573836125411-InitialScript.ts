...
export class InitialScript1573836125411 implements MigrationInterface {
    name = 'InitialScript1573836125411'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "parts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(36) NOT NULL, "partId" character varying(36) NOT NULL, "description" character varying(255), "material" text, "system" character varying, "customFields" json NOT NULL, "typeId" uuid, CONSTRAINT "UQ_eaeaaed9ed80a748d58fd2d4196" UNIQUE ("partId"), CONSTRAINT "REL_2edd74ec1e586047768f7478f3" UNIQUE ("typeId"), CONSTRAINT "PK_daa5595bb8933f49ac00c9ebc79" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "parts" ADD CONSTRAINT "FK_2edd74ec1e586047768f7478f39" FOREIGN KEY ("typeId") REFERENCES "part_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "parts" DROP CONSTRAINT "FK_2edd74ec1e586047768f7478f39"`, undefined);
